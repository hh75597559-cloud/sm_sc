...
학습 진도 관리 (완료율 표시)
➡️ 시각적 이해도 향상 + 자기주도 학습 가능

🔎 Q&A (RAG)

업로드한 PDF 기반 지능형 질의응답

FAISS 벡터 검색 + OpenAI/Gemini 응답 생성

출처 문서 표시
➡️ 신뢰성 있는 학습자료 기반 답변 제공
...
학습 점검용 피드백 제공
➡️ 시험 대비 & 자기 점검 학습 효과적

🎯 맞춤형 학습 경험

학습자료 ↔ Q&A ↔ 문제풀이 선순환 구조
